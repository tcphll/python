...
# TGBEGIN
win32 = """
The recommended Python for TurboGears is Python 2.5.1. You can download
it here:
...
other = """
The recommended Python for TurboGears is Python 2.5.1. This version of
...
def check_python():
    if sys.version_info < (2,3):
        print "Python 2.3 or higher is required to run TurboGears."

        if not get_python():
            sys.exit(1)

    elif sys.version_info < (2,4):
        print "TurboGears supports Python 2.3, but 2.4 is strongly recommended."
...
def install_command():
    ...
    Go to System Properties -> Advanced -> Environment Variables and add or edit the PATH variable to have ;C:\Python25;C:\Python25\Scripts, assuming you installed Python to the default location.""")
